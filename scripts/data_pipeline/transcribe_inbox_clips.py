#!/usr/bin/env python3
"""
transcribe_inbox_clips.py - Transcribe tagging inbox clips with Groq Whisper v3.

Given `channel_name`, this script:
1. Locates every MP4 inside data/channels/<channel>/tagging/inbox (or one clip via --clip-id).
...
4. Stores the verbose JSON response under tagging/transcripts/<clip>_tr.json.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Transcribe tagging inbox clips with Groq Whisper large v3.",
    )
...
def main() -> None:
    ...
    inbox_dir = channels_dir / args.channel_name / "tagging" / "inbox"
    transcripts_dir = channels_dir / args.channel_name / "tagging" / "transcripts"
