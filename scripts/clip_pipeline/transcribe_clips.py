...
1. Locates one clip or every MP4 inside data/channels/<channel>/<episode>/clips.
...
4. Stores the verbose JSON response under clips/transcripts/<clip>_whisper_v3.json.
...
def main() -> None:
    ...
    clip_root = channels_dir / args.channel_name / args.episode_id / "clips"
